  ...
  const ALFASection = () => {
    ...
    if (isMobile) {
      return (
       ...
       <section className="w-full flex justify-center items-center py-12 px-4">
          ...
          <div className="w-full max-w-sm bg-[#0d1b2a] rounded-2xl shadow-xl border border-[#1e2f47]">
    ...
    return (
      ...
      <section className="w-full min-h-screen bg-gradient-to-br from-[#081420] to-[#0a1929] flex justify-center items-center p-4 md:p-8">
        ...
        <div className="w-full max-w-[1400px] bg-[#0d1b2a] rounded-2xl shadow-2xl overflow-hidden border border-[#1e2f47]">
        
<div className="flex justify-end p-4">
  <span className="px-3 py-1 text-xs font-semibold rounded-full bg-yellow-400 text-black uppercase tracking-wide">
    Commissioning Soon
  </span>
</div>
